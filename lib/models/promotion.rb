class Promotion
  attr_reader :coupon_code, :season_price, :all_seasons_price, :episode_price, :price_per_episode_in_season, :price_per_episode_in_all_seasons
  ...
  def initialize(promotion_data)
    ...
    @all_seasons_price = Price.new(promotion_data.fetch("all_seasons_price_in_dollars"))
    ...
    @price_per_episode_in_all_seasons = Price.new(promotion_data.fetch("price_per_episode_in_all_seasons_in_dollars"))
